...
thumbnail: /images/posts/verl-post-training/verl-header.svg
tags: [RLHF, Verl]
...
<Image src='/images/posts/verl-post-training/verl_rl_framework.drawio.svg' alt='Verl Pipeline' width={1362} height={867} className='h-fit' />
