...
This guide walks through into RL post training. Then examine the three core components: actors, reward modules, and trainers; next, we build a simple math recipe using GSM8K dataset; and finally, analyze and understand training metrics such gradient norms, KL divergence, and reward curves. With these building blocks in place, you can start building your own recipes with verl.
