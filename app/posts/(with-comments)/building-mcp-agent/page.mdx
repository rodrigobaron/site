...
thumbnail: /images/posts/mcp-agent/mcp-agent-header.svg
tags: [MCP, Agent]
...
![Agent MEME](/images/posts/mcp-agent/meme.jpg "Agent MEME")

There are many Agent frameworks out there, and sure, some of them have their own special tricks, but at the end of the day, they're basically all doing the same thing (calling LLMs in a loop). So let's break it down and build our own Agents that can connect with any MCP server, just like this:
...
<Image src='/images/posts/mcp-agent/agent_diagram.svg' alt='Agent Diagram' width={1000} height={1000} className='h-fit' />
...
<Image src='/images/posts/mcp-agent/mcp.svg' alt='MCP' width={1000} height={1000} className='h-fit' />
...
```
![MCP Agent](/images/posts/mcp-agent/mcp_client.gif "MCP Agent")
